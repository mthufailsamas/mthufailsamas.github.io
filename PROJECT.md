...
- **Portfolio status:** Revision approved for direct publication. The public card no longer exposes internal experiment-version labels; release `20260827-02` is pending commit, Pages deployment, and live verification.
